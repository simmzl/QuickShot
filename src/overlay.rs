...
impl Overlay {
    pub fn create(event_loop: &ActiveEventLoop, frame: RgbaImage) -> Result<Self> {
        ...
        // Context::new takes ownership of the display handle provider (Rc<Window>).
        // Surface::new takes &Context and ownership of the window handle provider.
...
/// scaled to the window's pixel dimensions.
